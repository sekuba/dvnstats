...
function extractSecuritySnapshot(config) {
  ...
  return {
    ...
    isConfigTracked: firstDefined(config.isConfigTracked, null),
    ...
    defaultLibraryVersionId: firstDefined(config.defaultLibraryVersionId, null),
    defaultConfigVersionId: firstDefined(config.defaultConfigVersionId, null),
    libraryOverrideVersionId: firstDefined(config.libraryOverrideVersionId, null),
    configOverrideVersionId: firstDefined(config.configOverrideVersionId, null),
    fallbackFields: asArray(config.fallbackFields),
